% ============================================================
% sumida_shinshin_shogaisha_teate.pl - sumida ward disability welfare allowance
...
% Sources: tests/golden/sumida_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(sumida_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
