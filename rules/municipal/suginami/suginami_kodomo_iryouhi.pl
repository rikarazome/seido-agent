% ============================================================
% suginami_kodomo_iryouhi.pl - suginami ward child medical cost subsidy
...
% in tests/golden/suginami_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(suginami_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
