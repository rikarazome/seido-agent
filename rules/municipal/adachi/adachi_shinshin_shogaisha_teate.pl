% ============================================================
% adachi_shinshin_shogaisha_teate.pl - adachi ward disability welfare allowance
...
% Sources: tests/golden/adachi_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(adachi_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
