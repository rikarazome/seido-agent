% ============================================================
% adachi_kodomo_iryouhi.pl - adachi ward child medical cost subsidy
...
% in tests/golden/adachi_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(adachi_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
