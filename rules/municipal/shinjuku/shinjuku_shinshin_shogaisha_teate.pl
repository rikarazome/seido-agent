% ============================================================
% shinjuku_shinshin_shogaisha_teate.pl - shinjuku ward disability welfare allowance
...
% Sources: tests/golden/shinjuku_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(shinjuku_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
