% ============================================================
% itabashi_shinshin_shogaisha_teate.pl - itabashi ward disability welfare allowance
...
% Sources: tests/golden/itabashi_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(itabashi_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
