% ============================================================
% setagaya_shinshin_shogaisha_teate.pl - setagaya ward disability welfare allowance
...
% Sources: tests/golden/setagaya_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(setagaya_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
...
kettei_status(P, self, blocked(Missing)) :-
    ...
    Missing \= [], !.
kettei_status(P, self, decided(monthly(16500))) :-
