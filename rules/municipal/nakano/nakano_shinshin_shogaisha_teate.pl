% ============================================================
% nakano_shinshin_shogaisha_teate.pl - nakano ward disability welfare allowance
...
% Sources: tests/golden/nakano_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(nakano_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
