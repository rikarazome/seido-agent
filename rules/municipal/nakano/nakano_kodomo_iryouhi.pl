% ============================================================
% nakano_kodomo_iryouhi.pl - nakano ward child medical cost subsidy
...
% in tests/golden/nakano_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(nakano_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
