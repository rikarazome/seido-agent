% ============================================================
% koto_shinshin_shogaisha_teate.pl - koto ward disability welfare allowance
...
% Sources: tests/golden/koto_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(koto_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
