% ============================================================
% edogawa_shinshin_shogaisha_teate.pl - edogawa ward disability welfare allowance
...
% Sources: tests/golden/edogawa_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(edogawa_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
