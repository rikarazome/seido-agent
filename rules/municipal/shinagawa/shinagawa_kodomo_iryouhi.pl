% ============================================================
% shinagawa_kodomo_iryouhi.pl - shinagawa ward child medical cost subsidy
...
% in tests/golden/shinagawa_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(shinagawa_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
