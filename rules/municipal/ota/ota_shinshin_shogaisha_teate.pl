% ============================================================
% ota_shinshin_shogaisha_teate.pl - ota ward disability welfare allowance
...
% Sources: tests/golden/ota_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(ota_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
