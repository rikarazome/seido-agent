% ============================================================
% kita_kodomo_iryouhi.pl - kita ward child medical cost subsidy
...
% in tests/golden/kita_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(kita_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
