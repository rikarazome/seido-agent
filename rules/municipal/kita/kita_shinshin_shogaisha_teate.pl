% ============================================================
% kita_shinshin_shogaisha_teate.pl - kita ward disability welfare allowance
...
% Sources: tests/golden/kita_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(kita_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
