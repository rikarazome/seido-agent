...
% Generated by batch script: up to 200,000 JPY (cram school fees).
% Repayment waived on enrollment (de facto grant).
% Target: children at FY-end age 14-15 (chu3) or 17-18 (ko3).
% Income limit: 2,322,000 + 490,000 * N (estimated from published
% household income thresholds converted via salary_to_shotoku).
% Subject: child.
