% ============================================================
% nerima_shinshin_shogaisha_teate.pl - nerima ward disability welfare allowance
...
% Sources: tests/golden/nerima_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(nerima_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
