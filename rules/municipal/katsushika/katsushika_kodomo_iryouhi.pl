% ============================================================
% katsushika_kodomo_iryouhi.pl - katsushika ward child medical cost subsidy
...
% in tests/golden/katsushika_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(katsushika_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
