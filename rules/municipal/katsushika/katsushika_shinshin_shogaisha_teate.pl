% ============================================================
% katsushika_shinshin_shogaisha_teate.pl - katsushika ward disability welfare allowance
...
% Sources: tests/golden/katsushika_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(katsushika_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
