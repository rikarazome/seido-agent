% katsushika_shugaku_enjo.pl - katsushika ward school attendance assistance
% Generated by batch script: elementary 65K, middle 75K (Ota ward official). hikazei-based.
% FY-end age 6-15 (elementary/middle school). Subject: child.
% Generated by scripts/gen_ward_shugaku_enjo.py.
% Requires engine.pl.

:- module(katsushika_shugaku_enjo, [kettei_status/3, required_fact/3]).
...
kettei_status(P, C, decided(yearly(65000))) :-
    claimant(P), kango_by(C, P), child(C), yes(hikazei(P)), elementary(C), !.
