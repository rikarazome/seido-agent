% ============================================================
% minato_shinshin_shogaisha_teate.pl - minato ward disability welfare allowance
...
% Sources: tests/golden/minato_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(minato_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
