% ============================================================
% meguro_kodomo_iryouhi.pl - meguro ward child medical cost subsidy
...
% in tests/golden/meguro_kodomo_iryouhi/statute_source.md.
% Ward residence is implied by the form's municipality selection.
% Requires engine.pl.
% ============================================================

:- module(meguro_kodomo_iryouhi, [kettei_status/3, required_fact/3]).
