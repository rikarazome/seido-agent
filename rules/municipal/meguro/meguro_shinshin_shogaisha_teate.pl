% ============================================================
% meguro_shinshin_shogaisha_teate.pl - meguro ward disability welfare allowance
...
% Sources: tests/golden/meguro_shinshin_shogaisha_teate/statute_source.md
% Requires engine.pl.
% ============================================================

:- module(meguro_shinshin_shogaisha_teate, [kettei_status/3, required_fact/3]).
