...
def test_interview_flow_end_to_end():
    ...
    resp = judge()
    assert resp["headline"]["monthly_yen"] == 35000   # jidou_teate(25k) + 018(10k)
    assert resp["headline"]["oneoff_yen"] == 340000   # birthday(100k) + akachan(100k) + hajimete(100k) + bukka(2x20k)
    ...
    household_answers = {"hitorioya": True, "hitorioya_jiyuu": "rikon",
                         ...
                         "iryouhi_10man": False, "otc_12000": True,
                         "kenshin_torikumi": True, "seimei_hoken": True,
                         "jishin_hoken": False, "jiei_gyou": False,
